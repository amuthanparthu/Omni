  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <div class="progress please_look">
            <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%">85%
          </div>
          </div>
        </td>
      ...
      <tr>
        ...
        <td>
          <div class="progress super_critical">
            <div class="progress-bar" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100" style="width:98%">98%
          </div>
        </td>
      ...
      <tr>
        ...
        <td>
          <div class="progress normal">
            <div class="progress-bar" role="progressbar" aria-valuenow="61" aria-valuemin="0" aria-valuemax="100" style="width:61%">61%
          </div>
        </td>
        <td><b>Normal</b></td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <div class="progress normal">
            <div class="progress-bar" role="progressbar" aria-valuenow="70.7" aria-valuemin="0" aria-valuemax="100" style="width:70.7%">70.7%
          </div>
        </td>
        <td><b>Normal</b></td>
      </tr>
